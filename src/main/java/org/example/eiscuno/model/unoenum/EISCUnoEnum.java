...
public enum EISCUnoEnum {
    ...
    RESERVE_BLUE("cards-uno/reserve_blue.png", "REVERSE"),
    RESERVE_YELLOW("cards-uno/reserve_yellow.png", "REVERSE"),
    RESERVE_GREEN("cards-uno/reserve_green.png", "REVERSE"),
    RESERVE_RED("cards-uno/reserve_red.png", "REVERSE"),
